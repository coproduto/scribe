...
pub fn duplicate<'a, Output>(source: &'a mut dyn Source<Output>) -> impl Source<(Output, Output)> + 'a
where Output: Copy {
    DuplicateSource { inner_source: source }
}
...
where Output: Clone {
    CloneSource { inner_source: source }
}
...
impl<'a, FirstInput, SecondInput> Source<(FirstInput, SecondInput)> for JoinSource<'a, FirstInput, SecondInput> {
...
impl<'a, FirstInput, SecondInput, FirstOutput, SecondOutput> Source<(FirstOutput, SecondOutput)> for BimapSource<'a, FirstInput, SecondInput, FirstOutput, SecondOutput> {
